	...
	<body>
		...
		<div id="show-contact" class="content scaffold-show" role="main">
			...
			<ol class="property-list contact">
				...
				<g:if test="${contactInstance?.fullname}">
				<li class="fieldcontain">
					<span id="fullname-label" class="property-label"><g:message code="contact.fullname.label" default="Fullname" /></span>
					
						<span class="property-value" aria-labelledby="fullname-label"><g:fieldValue bean="${contactInstance}" field="fullname"/></span>
