	...
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
              ...
              <link rel="stylesheet" media="all" href="${resource(dir: 'css', file: 'style.css')}" type="text/css">
        	  	<link rel="stylesheet"  media="screen and (max-width: 960px)" href="${resource(dir: 'css', file: 'lessthen800.css')}" type="text/css">
		...
		<link rel="stylesheet" href="${resource(dir: 'css', file: 'custom-style.css')}" type="text/css">
...
<!-- slider related CSS -->
 <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-nivo.css')}" type="text/css">
 <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-nivo.css')}" type="text/css">
 <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-nivo.css')}" type="text/css">
 <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-elastic.css')}" type="text/css">
 <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-cycle.css')}" type="text/css">
  <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-thumbnails.css')}" type="text/css">
 <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-elegant.css')}" type="text/css">
 <link rel="stylesheet"  href="${resource(dir: 'css', file: 'slider-nivo.css')}" type="text/css">
<!-- end of Slider related css -->
 		<g:layoutHead/>
		<g:javascript library="simple"/>		
		<r:layoutResources />
	</head>
